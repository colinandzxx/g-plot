...
#define PERM_ELT(xa0, xa1, xb0, xb1, xb2, xb3, xc, xm)                      \
  do                                                                        \
  {                                                                         \
    xa0 = T32((xa0 ^ (((xa1 << 15) | (xa1 >> 17)) * 5U) ^ xc) * 3U) ^ xb1 ^ \
          (xb2 & ~xb3) ^ xm;                                                \
...
__device__ static const sph_u32 A_init_192[] = {
...
__device__ static const sph_u32 B_init_192[] = {
...
__device__ static const sph_u32 C_init_192[] = {
...
__device__ static const sph_u32 A_init_224[] = {
...
__device__ static const sph_u32 B_init_224[] = {
...
__device__ static const sph_u32 C_init_224[] = {
...
__device__ static const sph_u32 A_init_256[] = {
...
__device__ static const sph_u32 B_init_256[] = {
...
__device__ static const sph_u32 C_init_256[] = {
...
__device__ static const sph_u32 A_init_384[] = {
...
__device__ static const sph_u32 B_init_384[] = {
...
__device__ static const sph_u32 C_init_384[] = {
...
__device__ static const sph_u32 A_init_512[] = {
    C32(0x20728DFD), C32(0x46C0BD53), C32(0xE782B699), C32(0x55304632),
    C32(0x71B4EF90), C32(0x0EA9E82C), C32(0xDBB930F1), C32(0xFAD06B8B),
    C32(0xBE0CAE40), C32(0x8BD14410), C32(0x76D2ADAC), C32(0x28ACAB7F)};

__device__ static const sph_u32 B_init_512[] = {
    C32(0xC1099CB7), C32(0x07B385F3), C32(0xE7442C26), C32(0xCC8AD640),
    C32(0xEB6F56C7), C32(0x1EA81AA9), C32(0x73B9D314), C32(0x1DE85D08),
    C32(0x48910A5A), C32(0x893B22DB), C32(0xC5A0DF44), C32(0xBBC4324E),
    C32(0x72D2F240), C32(0x75941D99), C32(0x6D8BDE82), C32(0xA1A7502B)};

__device__ static const sph_u32 C_init_512[] = {
...
__device__ static void shabal_init(void *cc, unsigned size)
{
  /*
...
__device__ static void shabal_core(void *cc, const unsigned char *data, size_t len)
{
  sph_shabal_context *sc;
  unsigned char *buf;
  size_t ptr;
...
__device__ static void shabal_close(void *cc, unsigned ub, unsigned n, void *dst,
                                    unsigned size_words)
{
  sph_shabal_context *sc;
  unsigned char *buf;
...
/* see sph_shabal.h */
__device__ void sph_shabal192_init(void *cc) { shabal_init(cc, 192); }

/* see sph_shabal.h */
__device__ void sph_shabal192(void *cc, const void *data, size_t len)
{
  shabal_core(cc, (unsigned char *)data, len);
}

/* see sph_shabal.h */
__device__ void sph_shabal192_close(void *cc, void *dst)
{
  shabal_close(cc, 0, 0, dst, 6);
}

/* see sph_shabal.h */
__device__ void sph_shabal192_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                                void *dst)
{
...
/* see sph_shabal.h */
__device__ void sph_shabal224_init(void *cc) { shabal_init(cc, 224); }

/* see sph_shabal.h */
__device__ void sph_shabal224(void *cc, const void *data, size_t len)
{
  shabal_core(cc, (unsigned char *)data, len);
}

/* see sph_shabal.h */
__device__ void sph_shabal224_close(void *cc, void *dst)
{
  shabal_close(cc, 0, 0, dst, 7);
}

/* see sph_shabal.h */
__device__ void sph_shabal224_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                                void *dst)
{
...
/* see sph_shabal.h */
__device__ void sph_shabal256_init(void *cc) { shabal_init(cc, 256); }

/* see sph_shabal.h */
__device__ void sph_shabal256(void *cc, const void *data, size_t len)
{
  shabal_core(cc, (unsigned char *)data, len);
}

/* see sph_shabal.h */
__device__ void sph_shabal256_close(void *cc, void *dst)
{
  shabal_close(cc, 0, 0, dst, 8);
}

/* see sph_shabal.h */
__device__ void sph_shabal256_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                                void *dst)
{
...
/* see sph_shabal.h */
__device__ void sph_shabal384_init(void *cc) { shabal_init(cc, 384); }

/* see sph_shabal.h */
__device__ void sph_shabal384(void *cc, const void *data, size_t len)
{
  shabal_core(cc, (unsigned char *)data, len);
}

/* see sph_shabal.h */
__device__ void sph_shabal384_close(void *cc, void *dst)
{
  shabal_close(cc, 0, 0, dst, 12);
}

/* see sph_shabal.h */
__device__ void sph_shabal384_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                                void *dst)
{
...
/* see sph_shabal.h */
__device__ void sph_shabal512_init(void *cc) { shabal_init(cc, 512); }

/* see sph_shabal.h */
__device__ void sph_shabal512(void *cc, const void *data, size_t len)
{
  shabal_core(cc, (unsigned char *)data, len);
}

/* see sph_shabal.h */
__device__ void sph_shabal512_close(void *cc, void *dst)
{
  shabal_close(cc, 0, 0, dst, 16);
}

/* see sph_shabal.h */
__device__ void sph_shabal512_addbits_and_close(void *cc, unsigned ub, unsigned n,
                                                void *dst)
{
...
int testCuda()
{
  ...
  if (cudaMalloc((void **)&g_out, GIRD_NUM * THREADS_PER_BLOCK * 32) != cudaSuccess)
  {
  ...
  if (cudaMemcpy(out, g_out, GIRD_NUM * THREADS_PER_BLOCK * 32, cudaMemcpyDeviceToHost) != cudaSuccess)
  {
